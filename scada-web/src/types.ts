...
export interface FactoryTestReportResponse {
  from: string
  to: string
  totalCount: number
  ...
  chartPoints: FactoryTestReportChartPoint[]
  generatedAt: string
}

export interface FaultTrackingReportResponse {
  from: string
  to: string
  totalCount: number
  returnedCount: number
...
export interface FaultTracePoint {
  sj: string
  current: string | null
...
export interface FaultTraceResponse {
  occurredAt: string
  gw: number
  from: string
  to: string
  points: FaultTracePoint[]
}

export interface FactoryTestReportColumn {
  key: string
  label: string
  group: string
...
export interface FactoryTestReportChartPoint {
  sj: string | null
