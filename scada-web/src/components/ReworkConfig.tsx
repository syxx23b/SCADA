                ...
                <tbody>
                  {entries.suggestions.map((item) => (
                    <tr key={`s-${item.id}`}>
                      ...
                      <td>
                        <button type="button" className="danger-action" onClick={() => void handleDeleteSuggestion(item.id)}>删除</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
                        ...
                        {row.measure ? (
                          <div className="rework-map-node-row">
                            ...
                            <div className="rework-map-node-actions rework-map-node-actions-inline">
                              <button type="button" className="danger-action" onClick={() => void handleDeleteMapping(row.measure.mappingId)}>
                                删除匹配关系
                              </button>
                            </div>
                          </div>
